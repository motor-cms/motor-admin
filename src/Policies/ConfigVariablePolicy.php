...
class ConfigVariablePolicy
{
    ...
    {
        return $user->hasPermissionTo('config-variables.read');
    }
    ...
    {
        return $user->hasPermissionTo('config-variables.write');
    }
    ...
    {
        return $user->hasPermissionTo('config-variables.delete');
    }
